...
/* plugins */
    ...
    yukon_gmaps = {
        init: function() {
            ...
            $('#gmap_static').append('<span class="gmap-assets" style="height:100%;display:block;background: url('+url+img_scale+') no-repeat 50% 50%;'+background_size+'"><img src="'+url+'" style="visibility:hidden" alt="" /></span>');
    ...
    /**
     * id是world_map_vector的元素标记着地图，已被删除！
     */
    // vector maps
    yukon_vector_maps = {
        p_dashboard: function() {
